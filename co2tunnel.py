...
data = numpy.genfromtxt(csv_path, filling_values=[float("nan")])
...
(marker,) = ax.plot([], [], ".", alpha=0.3, ms=10, mfc="black")
line = collections.LineCollection(
    [],
    linewidth=10,
    alpha=0.2,
    cmap=plt.get_cmap("afmhot"),
    norm=plt.Normalize(300, 500),
)
...
def animate(t):
    ...
    frame_filename = os.path.join("frames", f"{t}.png")
...
ani.save("gifs/co2.gif", dpi=60, fps=10, writer="imagemagick")
